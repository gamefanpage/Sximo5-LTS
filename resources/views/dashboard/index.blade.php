	...
	<div class="page-content row">
		<div class="page-header">
			<div class="page-title">
				<h3><i class="fa fa-desktop"></i> Dashboard
		...
		<div class="page-content-wrapper">
			...
			@if(Auth::check() && Auth::user()->group_id == 1)
				...
				<span class="h3 block m-t-xs"><strong>  {{ Lang::get('core.dash_i_module') }}  </strong>
								...
								<small class="text-muted text-uc">  {{ Lang::get('core.dash_module') }}</small>
							</a>
						</div>
						<div class="col-sm-6 col-md-3 b-r  p-sm">
				...
				<span class="h3 block m-t-xs"><strong> {{ Lang::get('core.dash_i_setting') }}</strong>
								...
								<small class="text-muted text-uc">   {{ Lang::get('core.dash_setting') }} </small>
							</a>
						</div>
						<div class="col-sm-6 col-md-3 b-r  p-sm">
							...
							<a href="{{ URL::to('sximo/menu') }}" class="clear">
								...
								<small class="text-muted text-uc">  {{ Lang::get('core.dash_sitemenu') }}  </small>
							</a>
						</div>
						<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<span class="h3 block m-t-xs"><strong> {{ Lang::get('core.dash_i_usergroup') }}</strong>
								...
								<small class="text-muted text-uc">  {{ Lang::get('core.dash_usergroup') }} </small>
							</a>
						</div>
					</div>
				</section>
