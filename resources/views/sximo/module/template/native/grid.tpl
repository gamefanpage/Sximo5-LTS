        ...
        <div class="sbox">
            ...
            <div class="sbox-content">
                <div class="toolbar-line ">
                    ...
                    @endif
                    <a href="{{ URL::to( '{class}/search/native') }}" class="btn btn-sm btn-white" onclick="SximoModal(this.href,'Advance Search'); return false;"><i class="fa fa-search"></i>
                        Search</a>
                    ...
                    <table class="table table-striped ">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ URL::to('{class}/show/'.$row->{key}.'?return='.$return)}}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_view') }}"><i
                                            class="fa  fa-search "></i></a>
                                @endif
                                @if($access['is_edit'] ==1)
                                <a href="{{ URL::to('{class}/update/'.$row->{key}.'?return='.$return) }}" class="tips btn btn-xs btn-success" title="{{ Lang::get('core.btn_edit') }}"><i
