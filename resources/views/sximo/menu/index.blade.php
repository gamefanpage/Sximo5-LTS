	...
	<div class="page-content row">
		...
		<div class="page-header">
			<div class="page-title">
				<h3> {{ Lang::get('core.t_menu') }}
					<small>{{ Lang::get('core.t_menusmall') }}</small>
				</h3>
			</div>
		</div>
		...
		<div class="page-content-wrapper">
			<ul class="nav nav-tabs" style="margin:10px 0;">
				...
				<li @if($active == 'sidebar') class="active" @endif><a href="{{ URL::to('sximo/menu?pos=sidebar')}}"><i class="icon-paragraph-justify2"></i> {{ Lang::get('core.tab_sidemenu') }}</a>
				</li>
			</ul>
					...
					<div class="form-group  ">
						...
						<div class="col-md-8">
							...
							<p> {{ Lang::get('core.fr_musage') }}
								<a href="{{ url('core/template?show=icons')}}" target="_blank"> Font Awesome </a> and <a href="{{ url('core/template?show=icon-moon')}}" target="_blank"> Icomoon </a>
							                                                                                      class name</p>
						</div>
					</div>
					<div class="form-group  ">
