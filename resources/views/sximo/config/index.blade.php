							...
							<div class="sbox-content">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input name="cnf_domain" type="text" id="cnf_domain" class="form-control input-sm" required value="{{ CNF_DOMAIN }}"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="ipt" class=" control-label col-md-4">{{ Lang::get('core.fr_emailcontact') }} </label>

										<div class="col-md-8">
											<input name="cnf_contactemail" type="text" id="cnf_contactemail" class="form-control input-sm" value="{{ CNF_CONTACTEMAIL }}"/>
										</div>
									</div>

									<div class="form-group">
										<label for="ipt" class=" control-label col-md-4">{{ Lang::get('core.fr_emailcontact2') }} </label>

										<div class="col-md-8">
											<input name="cnf_contactemail2" type="text" id="cnf_contactemail2" class="form-control input-sm" value="{{ CNF_CONTACTEMAIL2 }}"/>
										</div>
									</div>

									<div class="form-group">
										<label for="ipt" class=" control-label col-md-4">{{ Lang::get('core.fr_emailcontact3') }} </label>

										<div class="col-md-8">
											<input name="cnf_contactemail3" type="text" id="cnf_contactemail3" class="form-control input-sm" value="{{ CNF_CONTACTEMAIL3 }}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="ipt" class=" control-label col-md-4"> Muliti language <br/>
											<small> Only Layout Interface</small>
										</label>
