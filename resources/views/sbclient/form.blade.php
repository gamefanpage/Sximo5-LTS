  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('sbclient?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'sbclient/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Clients</legend>
								  ...
								  <div class="form-group  " >
									<label for="About The Company" class=" control-label col-md-4 text-left"> About The Company </label>
									<div class="col-md-6">
									  <textarea name='About' rows='5' id='editor' class='form-control editor '  
						 >{{ $row['About'] }}</textarea> 
									 </div> 
									 <div class="col-md-2">
					 	...
					 	<div >
						{!! SiteHelpers::showUploadedFile($row['Logo'],'/uploads/projects/clients') !!}
								  ...
								  <div class="form-group  " >
									<label for="UserID on System" class=" control-label col-md-4 text-left"> UserID on System </label>
									<div class="col-md-6">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('sbclient?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#UserID").jCombo("{{ URL::to('sbclient/comboselect?filter=tb_users:id:first_name|last_name') }}",
