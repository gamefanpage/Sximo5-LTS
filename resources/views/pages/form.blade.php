@if($setting['form-method'] =='native')
	<div class="sbox">
		...
		<div class="sbox-content">
			...
			<div class="col-md-12">
				<fieldset>
					<legend> Pages CMS Management</legend>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<button type="button" onclick="ajaxViewClose('#{{ $pageModule }}')" class="btn btn-success btn-sm"><i class="fa  fa-arrow-circle-left "></i> {{ Lang::get('core.sb_cancel') }}
					</button>
				</div>
			</div>
			{!! Form::close() !!}
