	...
	<nav style="margin-bottom: 0;" role="navigation" class="navbar navbar-static-top nav-inside">
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			@if(Auth::user()->group_id == 1)
				<li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"><i class="fa fa-desktop"></i>
			...
			<li class="user dropdown">
				<a class="dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">
					...
					<span class="hidden-xs">{{ Lang::get('core.m_myaccount') }}</span>
					<b class="caret"></b>
				</a>
				<ul class="dropdown-menu dropdown-menu-right icons-right">
			...
			<li class="hidden-xxs">
				<a class="btn" href="{{ URL::to('user/logout')}}">
					<i class="fa fa-power-off"></i> {{ Lang::get('core.m_logout') }}
				</a>
			</li>
