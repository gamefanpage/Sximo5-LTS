	...
	<div class="page-content row">
		...
		<div class="page-content-wrapper m-t">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="box">
						<h1 style="margin-top: 0;">H1 Tag Header
							<small>Inline heading note</small>
						</h1>
						...
						<p>Mauris <span class="text-danger">luctus nisi</span> sed erat pharetra nec hendrerit mi sagittis. <span class="text-info">Pellentesque</span> nulla erat, varius nec sagittis
						   a, pretium et est. </p>
						...
						<p>Cras nec nunc sit amet mi <span class="text-success">dictum sagittis</span> id vitae est. Aliquam id dolor non metus aliquam faucibus nec pretium mi <span
									class="text-muted">vestibulum</span></p>
						<h5>H5 Tag Header
							<small>Inline heading note</small>
						</h5>
				...
				<div class="col-md-6">
					<div class="box">
						...
						<p>To me this vast ivory-ribbed chest, with the long, unrelieved spine, extending far away from it in a straight line, not a little resembled the hull of a great ship new-laid
						   upon the stocks, when only some twenty of her naked bow-ribs are inserted, and the keel is otherwise, for the time, but a long, disconnected timber.</p>
						...
						<h4>Small</h4>
						<small>This is a tiny small text!</small>
						<br>
					</div>
