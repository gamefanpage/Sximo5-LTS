								...
								<tr>
									...
									<td>
										@if($access['is_detail'] ==1)
											...
											@else
												<a href="{{ url($row->alias)}}" target="_blank" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i
															class="fa  fa-search "></i></a>
											@endif
										@endif
										@if($access['is_edit'] ==1)
											<a href="{{ url('core/pages/update/'.$row->pageID.'?return='.$return) }}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_edit') }}"><i
