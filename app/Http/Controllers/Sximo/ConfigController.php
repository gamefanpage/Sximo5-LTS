...
class ConfigController extends Controller {
	...
	static function postSave(Request $request)
	{
		...
		if (!$validator->fails ())
		{
			...
			$val = "<?php \n";
			$val .= "define ('CNF_DOMAIN', '" . $request->input ('cnf_domain') . "');\n";
			...
			$val .= "define ('CNF_CONTACTEMAIL', '" . $request->input ('cnf_contactemail') . "');\n";
			$val .= "define ('CNF_CONTACTEMAIL2', '" . $request->input ('cnf_contactemail2') . "');\n";
			$val .= "define ('CNF_CONTACTEMAIL3', '" . $request->input ('cnf_contactemail3') . "');\n";
	...
	public function postLogin(Request $request)
	{
		...
		{
			$val = "<?php \n";
			$val .= "define ('CNF_DOMAIN', '" . CNF_DOMAIN . "');\n";
			...
			$val .= "define ('CNF_CONTACTEMAIL', '" . CNF_CONTACTEMAIL . "');\n";
			$val .= "define ('CNF_CONTACTEMAIL2', '" . CNF_CONTACTEMAIL2 . "');\n";
			$val .= "define ('CNF_CONTACTEMAIL3', '" . CNF_CONTACTEMAIL3 . "');\n";
